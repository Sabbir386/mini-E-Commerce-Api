Here’s a ready-to-use `README.md` content that you can directly copy-paste into your project:
...
*(Optional: Add ER diagram image as `ER-diagram.png` in the project)*
...
* **Live API:** [https://e-commerce-blond-omega-71.vercel.app/api/v1](https://e-commerce-blond-omega-71.vercel.app/api/v1)
